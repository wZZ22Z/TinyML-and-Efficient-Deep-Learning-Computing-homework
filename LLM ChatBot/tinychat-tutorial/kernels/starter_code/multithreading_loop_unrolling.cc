        ...
        for (int col = mat_args->start; col < mat_args->end; col += 4) {
            ...
            for (int ch = 0; ch < k;) {
                ...
                for (int qj = 0; qj < 32; qj++) {
                    ...
                    signed char w_de0_0 = (packed_int4_0 & 0x0F) - 8.0;
                    signed char w_de0_16 = (packed_int4_0 >> 4) - 8.0;

                    signed char w_de1_0 = (packed_int4_1 & 0x0F) - 8.0;
                    signed char w_de1_16 = (packed_int4_1 >> 4) - 8.0;

                    signed char w_de2_0 = (packed_int4_2 & 0x0F) - 8.0;
                    signed char w_de2_16 = (packed_int4_2 >> 4) - 8.0;

                    signed char w_de3_0 = (packed_int4_3 & 0x0F) - 8.0;
                    signed char w_de3_16 = (packed_int4_3 >> 4) - 8.0;
                    // TODO: int8 multiply and accumulate operation
                    intermediate_sum0 += a_int8[qj] * w_de0_0;
                    intermediate_sum0_2nd += a_int8[qj + 32] * w_de0_16;
                    intermediate_sum1 += a_int8[qj] * w_de1_0;
                    intermediate_sum1_2nd += a_int8[qj + 32] * w_de1_16;
                    intermediate_sum2 += a_int8[qj] * w_de2_0;
                    intermediate_sum2_2nd += a_int8[qj + 32] * w_de2_16;
                    intermediate_sum3 += a_int8[qj] * w_de3_0;
                    intermediate_sum3_2nd += a_int8[qj + 32] * w_de3_16;
                }
                // dequantize the sum into floating point
                acc0 += (float)intermediate_sum0 * s_a * s_w0;
